Gem::Specification.new do |s|
  ...
  s.files       = ["config/settings.yml.sample", "lib/daily-reporter.rb", "lib/daily-reporter/mail.rb", "lib/daily-reporter/task.rb", "lib/daily-reporter/settings.rb", "bin/daily-reporter"]
